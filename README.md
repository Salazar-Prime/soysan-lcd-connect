...
indicator otherwise. The footer shows Eastern time and the relative age of the
last status check. Time refreshes every second; status checks refresh every five
seconds.
